namespace ChallengeApp.Tests
{
    ...
    {
        [Test]
        public void TypWartosciowyIntEqual()
        {
            // arrange
            int number1 = 1;
            int number2 = 1;
        ...
        public void TypWartosciowyDouble()
        {
            ...
            double number2 = Math.Sqrt((Math.PI) * (Math.PI));
        ...
        {
            // arrange
            string imiePieska = "IronMaiden";
            string imieKotka = "IronMaiden";
            //act
        ...
        public void TypReferencyjnyTestImienia()
        {
            ...
            //asert
            Assert.That(user1.Name, Is.EqualTo(user2.Name));
